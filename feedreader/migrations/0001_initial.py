...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feedreader_outline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'feedreader', ['Outline'])

        # Adding model 'Post'
        db.create_table(u'feedreader_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'feedreader', ['Post'])

        # Adding model 'UserPost'
        db.create_table(u'feedreader_userpost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'feedreader', ['UserPost'])

        # Adding unique constraint on 'UserPost', fields ['user', 'post']
        db.create_unique(u'feedreader_userpost', ['user_id', 'post_id'])

        # Adding model 'ConfigStore'
        db.create_table(u'feedreader_configstore', (
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'feedreader', ['ConfigStore'])

        # Adding unique constraint on 'ConfigStore', fields ['key', 'user']
        db.create_unique(u'feedreader_configstore', ['key', 'user_id'])

        # Adding model 'UserToken'
        db.create_table(u'feedreader_usertoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('expire', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'feedreader', ['UserToken'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConfigStore', fields ['key', 'user']
        db.delete_unique(u'feedreader_configstore', ['key', 'user_id'])

        # Removing unique constraint on 'UserPost', fields ['user', 'post']
        db.delete_unique(u'feedreader_userpost', ['user_id', 'post_id'])

        # Deleting model 'Feed'
        db.delete_table(u'feedreader_feed')

        # Deleting model 'Outline'
        db.delete_table(u'feedreader_outline')

        # Deleting model 'Post'
        db.delete_table(u'feedreader_post')

        # Deleting model 'UserPost'
        db.delete_table(u'feedreader_userpost')

        # Deleting model 'ConfigStore'
        db.delete_table(u'feedreader_configstore')

        # Deleting model 'UserToken'
        db.delete_table(u'feedreader_usertoken')
    ...
    models = {
        ...
        u'feedreader.outline': {
            'Meta': {'object_name': 'Outline'},
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feedreader.Feed']", 'null': 'True', 'blank': 'True'}),
            'folder_opened': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feedreader.Outline']", 'null': 'True', 'blank': 'True'}),
