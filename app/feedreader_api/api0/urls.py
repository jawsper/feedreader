...
urlpatterns = [
    ...
    path(
        "outlines/",
        outline.GetAllOutlinesView.as_view(),
        name="outline_get_all_outlines",
    ),
    path(
        "outline/get_all_posts/",
        outline.GetAllPostsView.as_view(),
        name="get_all_posts",
    ),  # unused
    path(
        "outline/get_starred_posts/",
        outline.GetStarredPostsView.as_view(),
        name="get_starred_posts",
    ),  # unused
    path("outline/get_posts/", outline.GetPostsView.as_view(), name="get_posts"),
    path(
        "outline/get_data/",
        outline.OutlineGetDataView.as_view(),
        name="get_outline_data",
    ),  # unused
    path("outline/set/", outline.OutlineSetView.as_view(), name="outline_set"),
    path(
        "outline/mark_as_read/",
        outline.OutlineMarkAsReadView.as_view(),
        name="outline_mark_read",
    ),
